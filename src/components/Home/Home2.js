        ...
        ? {
            ...
            body: (
                <>
                    ...
                    <br /><br />
                    目前我在<b className="text-accent">蔚来</b>担任 <b className="text-accent">AI Agent 工程师</b>，专注于面向制造运营的<b className="text-accent">企业级 AI Agent 系统</b>，以及 <b className="text-accent">LLM / RAG</b>、<b className="text-accent">流程自动化</b>与<b className="text-accent">数据驱动的决策支持</b>。我乐于把分析、建模与业务打通，沉淀为稳定、清晰、可持续演进的软件体验。
                    <br /><br />
