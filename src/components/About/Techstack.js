...
const techStackIcons = [
    ...
    // AI / Data
    { icon: <img src="https://cdn.simpleicons.org/langchain" alt="LangChain" style={{ width: "1em", height: "1em" }} />, name: "LangChain", link: "https://www.langchain.com/" },
    { icon: <img src="https://cdn.simpleicons.org/ollama" alt="Ollama" style={{ width: "1em", height: "1em" }} className="theme-invert" />, name: "Ollama", link: "https://ollama.com/" },
