export const projects = [
    ...
    },
    {
        ...
        description: {
            ...
            zh: "基于 DeBERTa 预训练语言模型构建的分层 NLP 系统，用于对真实轨道交通事件日志进行多层级自动分类。项目不仅包含模型训练与微调，还覆盖数据预处理、标签体系组织、评估流程设计等关键环节，更贴近真实业务中的文本理解需求。"
        },
    ...
    },
    {
        ...
        description: {
            ...
            zh: "基于 Qt 的原生桌面应用，可将原始列车运行数据转换为更直观的时空图与可视化结果，帮助研究人员围绕特定日期、区段和地点快速理解列车活动情况，并提升后续分析工作的效率。"
        },
